...
//        int myInt4 = myInteger5; // throws NullPointerException (primitive can't contain null )

        // boxing -> converting primitive to wrapper
        Integer myInteger6 = new Integer(10);

        //autoboxing -> automatically convert primitive type to wrapper
